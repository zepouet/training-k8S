...
Retirer un label au pod

```
kubectl label pods mytomcat owner-

kubectl get pods mytomcat --show-labels
NAME       READY     STATUS    RESTARTS   AGE       LABELS
mytomcat   1/1       Running   0          2m        env=development
...
````
kubectl create -f https://raw.githubusercontent.com/Treeptik/k8s-exercises/master/labels/tomcat-kevin.yaml
